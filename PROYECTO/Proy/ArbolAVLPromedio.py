...
class ArbolAVLPromedio:
    ...
    def buscar(self, promedio):
        """
        Busca un promedio en el árbol y retorna True si lo encuentra, False si no lo encuentra.
        """
        nodo_actual = self.raiz
        while nodo_actual is not None:
            if promedio == nodo_actual.dato:
                return True
            elif promedio < nodo_actual.dato:
    ...
    def __egresados_en_orden(self, nodo, datos_egresados):
        if nodo is not None:
            ...
            promedio = nodo.dato
            egresados_promedio = [egresado for egresado in datos_egresados if egresado[2] == promedio]
            for egresado in egresados_promedio:
