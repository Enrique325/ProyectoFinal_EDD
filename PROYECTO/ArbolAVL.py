...
class ArbolAVL:
    ...
    def busqueda_inorden_avl(self, indice_buscado):
        return self.__busqueda_inorden_avl(self.raiz, indice_buscado)

    def __busqueda_inorden_avl(self, nodo, indice_buscado):
        if nodo is None:
            return None
